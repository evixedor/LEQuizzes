  ...
  return (
    <>
      ...
      <div className={styles.fourthcontent}>
        <Link href="/articles/articlelist/advice-for-english-learners" className={styles.button1}>
          <button>Next Article</button>
        </Link>
        <Link href="/articles" className={styles.button2}>
          <button>Articles Home</button>
        </Link>
        <Link href="/articles/articlelist/the-subjunctive-mood" className={styles.button2}>
