				...
				<Typography>
					<div className="col-12 menu text-sky-400">
						<ul>
							...
							<li>
								<a href="/articles/articlelist/elusive">
							...
							<li>
								<a href="/articles/articlelist/transitive">
									Transitive vs Intransitive Verbs
									<span className="authorNameMain"> by Emily Rowan</span>
								</a>
							</li>
							<li>
								<a href="/articles/articlelist/punctuation2">
							...
							<li>
								<a href="/articles/articlelist/apostrophes">
									Apostrophe's Are Often Misused
									<span className="authorNameMain"> by Ellen Kersey</span>
								</a>
							</li>
							<li>
								<a href="/articles/articlelist/cliches">
									Cliches/Aphorisms
